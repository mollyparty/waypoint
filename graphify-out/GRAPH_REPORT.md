...
## Corpus Check
- 61 files · ~71,336 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 107 nodes · 287 edges · 7 communities
- Extraction: 53% EXTRACTED · 9% INFERRED · 1% AMBIGUOUS · INFERRED: 27 edges (avg confidence: 0.74)
- Token cost: 5,600 input · 1,350 output
...
8. `Changelog` - 12 edges
9. `Adaptive route generation (hero wedge)` - 12 edges
10. `Graphify Knowledge Graph` - 11 edges
...
- `Waypoint Agent Protocol` --references--> `Agent Attribution Footer`  [EXTRACTED]
  AGENTS.md → docs/VERSIONING.md
...
Cohesion: 0.14
Nodes (26): Charter (Waypoint product charter stub), Engineering mantra: security, stability, reliability, compliance, Adaptive route generation (hero wedge), DEC-005: Phased research program with gated approvals, Industry trends research (wearables, AI coaching, subscriptions, routing tech, running culture), Market landscape research (running, fitness, AI coaching markets), Market sizing: TAM $1.3B to $2.9B, SAM 14M runners, SOM $5M to $30M ARR, Regulatory and compliance research (location, health data, AI Act, accessibility, subscriptions) (+18 more)

### Community 1 - "Agent Protocol and Memory Infrastructure"
Cohesion: 0.29
Nodes (22): Context Retrieval Order, Waypoint Agent Protocol, Session-End Checklist, CLAUDE.md (Claude Code pointer file), Cross-IDE / cross-tool compatibility (Cursor, Codex CLI, Claude Code, Gemini CLI, others), .gitattributes line-ending normalization (eol=lf), CONTRIBUTING.md (collaborator onboarding doc), DEC-002 Obsidian vault as project memory (+14 more)

### Community 2 - "Versioning and Project Identity"
Cohesion: 0.24
Nodes (21): Changelog, Keep a Changelog Format, Semantic Versioning, DEC-001 Trunk-based versioning on main, Obsidian Vault as Project Memory, Token Cost Telemetry, Agent Attribution Footer, Conventional Commits (+13 more)

### Community 3 - "Phase 2 Competitive Landscape and Threats"
Cohesion: 0.18
Nodes (14): Business intent: venture-scale, freemium subscription, seed in 12 months, AllTrails (Peak tier AI route adjustments, trail-locked), Komoot (Bending Spoons-owned, declining, bike/hike-first), Runna (Strava-owned, category-leading AI training app), Strava (platform: routes, heatmap, Runna owner), Competitor feature matrix, Competitive gap analysis (H2/H3 verdicts, threats, window), Competitor positioning maps (training vs route intelligence) (+6 more)

### Community 4 - "Research Program, Constraints, and Open Decisions"
Cohesion: 0.20
Nodes (11): Constraint: data enclosure forces HealthKit-first and a proprietary context-data moat, Interview backlog (validation plan for desk findings), Open decision: must safety-critical routing be free (ethics and pricing), Phase 5: Product definition and MVP scope, Phase 6: Business model and go-to-market, Phase 7: HTML research dashboard on Vercel (deployment protection required), Research Playbook (research/00-RESEARCH-PLAYBOOK.md), Nine-phase gated research program (Phase 0 to Phase 8) (+3 more)
...
## Knowledge Gaps
- **14 isolated node(s):** `alwaysUpdateLinks`, `newLinkFormat`, `useMarkdownLinks`, `attachmentFolderPath`, `showUnsupportedFiles` (+9 more)
...
- **What is the exact relationship between `Charter (Waypoint product charter stub)` and `Knowledge Index`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **Why does `START HERE (Home Note)` connect `Agent Protocol and Memory Infrastructure` to `Product Wedge, Market Evidence, and Hypothesis Verdicts`, `Versioning and Project Identity`, `Research Program, Constraints, and Open Decisions`?**
  _High betweenness centrality (0.427) - this node is a cross-community bridge._
- **Why does `Nine-phase gated research program (Phase 0 to Phase 8)` connect `Research Program, Constraints, and Open Decisions` to `Product Wedge, Market Evidence, and Hypothesis Verdicts`, `Agent Protocol and Memory Infrastructure`, `Phase 2 Competitive Landscape and Threats`, `Phase 3 User Research and Personas`?**
  _High betweenness centrality (0.310) - this node is a cross-community bridge._
- **Why does `Phase 2: Competitor analysis` connect `Phase 2 Competitive Landscape and Threats` to `Product Wedge, Market Evidence, and Hypothesis Verdicts`, `Research Program, Constraints, and Open Decisions`, `Phase 3 User Research and Personas`?**
