...
Index of all project decisions. One note per decision, numbered sequentially. Status is one of: proposed, accepted, superseded, rejected.
...
1. Copy [[Decision-Record]] from `_templates/`.
2. Name it `DEC-NNN Short title` with the next number.
3. Add a row to the table above and update this note's `updated` date.
